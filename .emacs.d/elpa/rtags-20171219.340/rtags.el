        ...
        (t
         ...
         (when (and rtags-popup-results-buffer
           ...
           (rtags-switch-to-buffer rtags-buffer-name
                   ...
                   ; (shrink-window-if-larger-than-buffer)) tastolfi
           )
...
;;;###autoload
(defun rtags-close-taglist () ; tastolfi
  (window-list))
  ;(interactive)
...
;;;###autoload
(defun rtags-remove-other-window () nil) ; tastolfi
  ;(interactive)
  ;(let ((ret ""))
